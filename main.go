...
func main() {
	...
	db_connection := "user=postgres dbname=cbi password=root host=/cloudsql/cbi:us-central1:mypostgres sslmode=disable port = 5432"
...
func GetTaxiTrips(db *sql.DB) {
	...
	geocoder.ApiKey = "AIzaSyCpRAF4180uAXc9Bqzb6iWyGmACc1vNIjA"
